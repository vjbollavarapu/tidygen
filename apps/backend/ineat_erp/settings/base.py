...
WSGI_APPLICATION = 'ineat_erp.wsgi.application'

# Database
DATABASES = {
    'default': dj_database_url.parse(
        config('DATABASE_URL', default='postgresql://ineat_user:ineat_password@localhost:5432/ineat_erp')
    )
}
